...
api.prototype.postData = function (path, token, data, callback) {
...
api.prototype.getData = function (path, token, callback) {
///NOTE: Handle the request using the handleRequest method above instead of repeating yourself .
    var options = {
        host: Host,
        path: path,
...
api.prototype.deleteData = function (path, token, callback) {
///NOTE: Handle the request using the handleRequest method above instead of repeating yourself .
    var options = {
        host: Host,
        path: path,
